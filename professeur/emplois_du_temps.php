...
$nbValides  = count(array_filter($rows, fn($r) => $r['statut'] === 'valide'));
...
@media print {
  ...
  * {
  ...
  body {
    ...
    font-size: 9pt; margin: 0 !important; padding: 0 !important;
  }
  ...
  .ph-logo {
    ...
    flex-shrink: 0; color: #fff; font-size: 22pt;
  }
  ...
  .pt-table th {
    ...
    font-weight: 700; font-size: 7.5pt; padding: 5pt 3pt;
    text-align: center; border: 1pt solid #1346C0;
    text-transform: uppercase; letter-spacing: .25pt;
  }
  .pt-table th.th-time { text-align:left; width:50pt; background:#0F1C3F !important; padding-left:5pt; }
  .pt-table td { border:1pt solid #E5E9F2; padding:0; vertical-align:top; height:36pt; }
  .pt-table td.td-time {
    font-size: 7pt; font-weight: 700; color: #374151;
    background: #F8F9FC !important; text-align: center;
    padding: 4pt 3pt; border-right: 2pt solid #C8D0E0;
    white-space: nowrap; vertical-align: middle;
  }
  .pt-table tr:nth-child(even) td.td-time { background: #EFF3FA !important; }
  .td-free { background: #FAFAFA !important; }

  .pc { height: 100%; padding: 2.5pt 4pt; border-left: 3pt solid transparent; }
  ...
  .pc-room { font-size: 6pt; color: #6B7280; margin-bottom: 1pt; }
  .pc-badge {
    display: inline-block; font-size: 5.5pt; padding: 1pt 3pt;
    border-radius: 99pt; font-weight: 700;
  }
  ...
  .pl-wrap {
    display: flex !important; flex-wrap: wrap; gap: 5pt 10pt;
    margin-top: 7pt; padding-top: 6pt; border-top: 1pt solid #E5E9F2;
  }
  ...
  .pf-wrap {
    ...
    border-top: 1pt solid #E5E9F2; font-size: 7pt; color: #9CA3AF;
  }
...
<div class="main-content">
  ...
  <div class="stat-grid no-print" style="margin-bottom:1.5rem">
    ...
    <div class="stat-card">
      ...
      <div><div class="stat-value"><?= $nbValides ?></div><div class="stat-label">Validés</div></div>
    </div>
  </div>
...
<div id="print-zone">
  ...
  <div class="pstat-row">
    ...
    <div class="pstat"><div class="pstat-val"><?= $nbValides ?></div><div class="pstat-lbl">Créneaux validés</div></div>
  </div>
  ...
  <table class="pt-table">
    ...
    <tbody>
      ...
      <tr>
        <td class="td-time">
          <?= formatHeure($hD) ?><br>
          <span style="font-weight:400;color:#9CA3AF"><?= formatHeure($hF) ?></span>
        </td>
        <?php foreach ($jours as $j): $cell = $joursData[$j] ?? null; ?>
